...
<body>
  <main class="card" role="main" aria-labelledby="title">
    ...
    <div class="actions" role="group" aria-label="Tindakan">
      ...
      <a class="btn btn-ghost" href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp_admin; ?>&text=Halo Admin, tolong dibantu IP saya <?php echo donasiyuk_getIP(); ?> tidak bisa akses page.">WA Admin</a>
      <?php } ?>
    </div>
    
    <div class="meta" aria-live="polite">
      <div>Request ID: <code id="reqId">—</code></div>
      <div>Alamat IP Anda: <code><?php echo donasiyuk_getIP(); ?></code></div>
