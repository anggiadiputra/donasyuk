...
<body>
	...
	<div id="register_section" class="section-box" style="border-radius:12px;padding:40px 40px 60px 40px;background: url('<?php echo plugin_dir_url( __FILE__ ).'assets/images/bg.png'; ?>') no-repeat, #fff;margin-top: 30px;">
		<div class="donasiyuk-box" style="margin-bottom: 10px;margin-top: 10px;"><a href="<?php echo $home_url; ?>" target="_self"><img alt="DonasiYuk" class="" src="<?php echo $logo_url; ?>" style="width: 120px;border-radius: 4px;"></a></div>
			...
			<div class="form-group" id="form-group">
				...
				<div class="donasiyuk-input password-wrapper">
					...
					<!-- Mata terbuka -->
					<i class="icon-eye icon-eye-open hidden" data-lucide="eye"></i>

					<!-- Mata tertutup (ada garis) -->
					<i class="icon-eye icon-eye-closed" data-lucide="eye-off"></i>
				...
				<div class="donasiyuk-input" style="margin-top: 40px;">
	...
	jQuery(document).ready(function($) {
		...
		$("#register_now").bind("click", function(){
		    ...
		    var data = {
		        "action": "dykfunction_register_user",
		        "datanya": data_nya
		    };
