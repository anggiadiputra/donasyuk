...
function get_langArray($key, $lang = 'id') {
    ...
    $filePath = ABSPATH . "wp-content/plugins/donasiyuk/library/locale/{$lang}.php";
...
class TranslationManager {
    private static $translations = [
        'id' => [
			...
			// Settings > License
			// NOTE: 'member.donasiaja.id' is the license server (Sinkronus Co) — DO NOT rename; backend expects this URL.
			'license_desc' => 'Jelajahi keunggulan fitur-fitur premium kami. Aktifkan lisensi DonasiYuk sekarang untuk pengalaman terbaik yang tak terlupakan!',
			'license_desc2' => '<li>Aktivasi DonasiYuk dengan memasukkan API Key yang diperoleh dari <a href="https://member.donasiaja.id/login" style="text-decoration: underline;" target="_blank">Member Page</a></li><li>Jika saat aktivasi ada notif: <b>Your Activation is Full</b>, klik Deactivate terlebih dahulu &gt; Lalu klik Activate kembali.</li><li>Jika ingin menghapus license, klik tombol Deactivate.</li>',
			...
			'db_desc' => 'Silahkan klik <b>Update</b> jika anda baru mengupdate DonasiYuk ke versi terbaru secara otomatis, jika update Manual silahkan abaikan settingan ini.',
			...
			'general_desc3' => 'Aktifkan jika ingin menggunakan login bawaan DonasiYuk.',
        ...
        'en' => [
			...
			'dash_setting_desc1' => 'Aktifkan jika ingin mengikuti dengan menggunakan Wanotif. Pastikan Wanotif anda telah diatur atau dalam keadaan aktif agar pesan dapat dikirim. (<a href="http://localhost:8888/wp/wp-admin/admin.php?page=donasiyuk_settings&amp;action=notification" target="_blank">Setting Wanotif</a>)',
			...
			// Settings > License
			'license_desc' => 'Terokai keunggulan ciri-ciri premium kami. Aktifkan lesen DonasiYuk sekarang untuk pengalaman terbaik yang tidak akan dilupakan!',
			...
			'db_desc' => 'Sila klik <b>Update</b> jika anda baru sahaja mengemaskini DonasiYuk ke versi terbaru secara automatik. Jika kemas kini dilakukan secara manual, sila abaikan tetapan ini.',
			...
			'general_desc3' => 'Aktifkan jika ingin menggunakan login DonasiYuk yang disediakan.',
