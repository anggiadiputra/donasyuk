<?php
	...
	require_once dirname(__DIR__) . '/plugins/phpspreadsheet/autoload.php';
	use PhpOffice\PhpSpreadsheet\Helper\Sample;
	use PhpOffice\PhpSpreadsheet\IOFactory;
	use PhpOffice\PhpSpreadsheet\Spreadsheet;

	global $wpdb;
    $table_name = $wpdb->prefix . "dyk_donate";
    $table_name2 = $wpdb->prefix . "dyk_campaign";
    $table_name3 = $wpdb->prefix . "dyk_aff_submit";
    $table_name4 = $wpdb->prefix . "dyk_aff_code";
   	$campaign_id = $c_id;
	...
	$spreadsheet->getProperties()->setCreator('DonasiYuk')
	    ->setLastModifiedBy('DonasiYuk')
	...
	$spreadsheet->setActiveSheetIndex(0)->setCellValue('A'.$powered_row, 'This Data Download Powered By DonasiYuk');
