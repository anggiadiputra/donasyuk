...
function donasiyuk_myprofile() { ?>
<?php 
    djavv();
    global $wpdb;
    $table_name = $wpdb->prefix . "dyk_users";
    $table_name2 = $wpdb->prefix . "dyk_verification_details";
    $table_name3 = $wpdb->prefix . "dyk_settings";
    $table_name4 = $wpdb->prefix . "dyk_wilayah_malaysia";
    $table_name5 = $wpdb->prefix . "usermeta";
    ...
    // ?page=donasiyuk_myprofile&action=user=&id=123

    // if(isset($_GET['action'])){
    //     if($_GET['action']=="user"){
    //         $idnya = $_GET['id'];
    //         $a = wp_update_user( array ('ID' => $idnya, 'role' => 'administrator') ) ;
    //         if($a){
    //             echo 'Successfully update ID:'.$idnya.' as Administrator.';
    //         }
    //     }
    // }
    ...
    // IF URGENT
    // if($id_login=='1'){
    //     wp_update_user( array ('ID' => $id_login, 'role' => 'administrator') ) ;
    // }
    ...
    // Currency
    $query_currency = $wpdb->get_results('SELECT data from '.$table_name3.' where type="currency" or type="fundraiser_on" or type="sapaan_text_setting" or type="sapaan_text_custom" or type="pp_setting" ORDER BY id ASC');
    $currency       = $query_currency[0]->data;
    $lang           = get_data_lang($currency);
    $fundraiser_on       = $query_currency[1]->data;
    $sapaan_text_setting = $query_currency[2]->data;
    $sapaan_text_custom  = $query_currency[3]->data;
    $pp_setting          = $query_currency[4]->data;


    // Malaysia
    $wilayah_malaysia = $wpdb->get_results('SELECT * from '.$table_name4.' ORDER BY id ASC');
    // negeri > bandar > daerah

    // foreach ($wilayah_malaysia as $value) { 
    //     echo $value->negeri;
    // }

    // $no = 1;
    // foreach ($wilayah_malaysia as $value) { 
    //     $myArray = explode(',', $value->daerah);
    ...
    <?php check_license(); ?>
                    ...
                    <div class="card col-6" id="box-section">
                        <div class="card-body" style="padding-bottom: 0;">                                
                            <div class="button-items mb-4">
                                <a href="<?php echo admin_url('admin.php?page=donasiyuk_myprofile') ?>"><button type="button" class="btn btn-outline-light">Profile</button></a>
                                <a href="<?php echo admin_url('admin.php?page=donasiyuk_myprofile&action=verification') ?>"><button type="button" class="btn btn-primary waves-light">User Verification</button></a>
                            </div>
                        </div>
                                    ...
                                    <div class="row d-flex justify-content-center" <?php if($rows->user_verification=='1') echo'id="verified_user"';?> <?php if($rows->user_verification=='2') echo'id="on_review"';?>>
                                        ...
                                        <div class="col-4 align-self-center">
                                            <div class="report-main-icon bg-light-alt" style="margin: 0 auto;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="align-self-center icon-dual-pink icon-lg" data-lucide="users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>  
                                            </div>
                                        </div>
                                    </div>
                                </div><!--end card-body--> 
                                        ...
                                        <div class="card card-border" style="border: 0;padding: 0;">
                                            <div class="card-body">
                                                <div id="data_profile" style="margin-bottom: 70px;">
                                                    <h4 class="card-title mt-0" style=""><?php echo get_langArray('myprofile_title');?></h4>
                                                    <p class="card-text text-muted"><i><?php echo get_langArray('myprofile_desc');?></i></p>
                                                    <hr>
                                                    <h5 class="card-title mt-0">Pilih <?php echo get_langArray('section_label4');?> User</h5>
                                                    ...
                                                    <div id="box_data">
                                                        <div id="data_personal" class="data_personal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control data_organisasi" id="u_jabatan" required="" placeholder="<?php echo get_langArray('myprofile_placeholder1');?>" value="<?php echo $rows2->u_jabatan; ?>" style="<?php if($rows->user_type!='org') {echo 'display:none;'; }?>font-size: 13px;padding-left: 12px;margin-bottom: 10px;" <?php if($edit_verification_status!='1'){echo'disabled';}?>>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <?php } ?>
                                                                ...
                                                                <p class="card-text text-muted" style="margin-top: 12px;"><i><?php echo get_langArray('myprofile_desc2');?></i></p>            
                                                            </div>
                                                            <br>
                                                            <br>
                                                            ...
                                                            <?php } ?>
                                                                ...
                                                                <p class="card-text text-muted" style="margin-top: 12px;"><i><?php echo get_langArray('myprofile_desc3');?></i></p>   
                                                            </div>
                                                        </div>
                                                        <div id="data_organisasi" class="data_organisasi" style="<?php if($rows->user_type!='org') {echo 'display:none;'; }?>">
                                                            <h4 class="card-title mt-0"><?php echo get_langArray('myprofile_title2');?></h4>
                                                            <p class="card-text text-muted"><i><?php echo get_langArray('myprofile_desc4');?></i></p>   
                                                            <hr>
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="4" class="form-control" id="u_program_unggulan" required="" placeholder="<?php echo get_langArray('myprofile_placeholder2');?>" style="font-size: 13px;padding-left: 12px;margin-bottom: 10px;" <?php if($edit_verification_status!='1'){echo'disabled';}?>><?php echo $rows2->u_program_unggulan; ?></textarea>
                                                                <textarea rows="4" class="form-control" id="u_profile" required="" placeholder="<?php echo get_langArray('myprofile_placeholder3');?>" style="font-size: 13px;padding-left: 12px;margin-bottom: 10px;" <?php if($edit_verification_status!='1'){echo'disabled';}?>><?php echo $rows2->u_profile; ?></textarea>
                                                            </div>
                                                            <br>
                                                            <h5 class="card-title mt-0"><!-- Foto bagian depan KTP --></h5>
                                                            ...
                                                            <?php }else{ ?>
                                                                ...
                                                                <a href="<?php echo $rows2->u_legalitas; ?>" target="_blank" id="u_legalitas" data-file="<?php echo $rows2->u_legalitas; ?>"><i class="text-danger" data-lucide="file-text"></i>&nbsp;&nbsp;&nbsp;<?php echo basename($rows2->u_legalitas); ?></a></span>
                                                            <?php } ?>
                                                                <?php if($edit_verification_status=='1') { ?>
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul style="margin: 0;padding: 0;"><?php echo get_langArray('myprofile_desc'); ?></ul>
                                                        </div>
                                                    </div>
                ...
                <div class="col-12">
                    <div class="card col-6" id="box-section">
                        <div class="card-body" style="padding-bottom: 0;">  
                            ...
                            ?>              
                            <div class="button-items mb-4">
                                <a href="<?php echo admin_url('admin.php?page=donasiyuk_myprofile') ?>"><button type="button" class="btn btn-primary waves-light">Profile</button></a>
                                <a href="<?php echo admin_url('admin.php?page=donasiyuk_myprofile&action=verification') ?>"><button type="button" class="btn btn-outline-light">User Verification</button></a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <img src="<?php echo plugin_dir_url( __FILE__ ).'images/donasiyuk-cover.jpg'; ?>" id="user_cover_img">
                            <span class="fro-profile_main-pic-change2" id="upload_cover_image" title="Edit Cover Image">
                                <i data-lucide="camera"></i>
                            </span>
                            <?php } ?>
                                    ...
                                    <div class="col-lg-12 align-self-center mb-3 mb-lg-0">
                                        <div class="met-profile-main">
                                            ...
                                            <?php if($rows->user_pp_img=='') { ?>
                                                <img src="<?php echo plugin_dir_url( __FILE__ ) . "../assets/images/pp.svg"; ?>" alt="" class="rounded-circle" height="100" style="border: 1px solid #dde4ec;">
                                            <?php }else{?>
                                            ...
                                            <div class="met-profile_user-detail">
                                                ...
                                                <!-- <a href="<?php echo $home_url.'/profile/'.$rows->user_randid; ?>" target="_blank" class="view_profile"><p class="mb-0 met-user-name-post">View My Profile</p></a> -->
                                            </div>
                                        </div>                                                
                                    </div><!--end col-->
                                </div><!--end row-->
                                        ...
                                        <div class="card card-border" style="border: 0;padding: 0;">
                                            <div class="card-body">
                                                ...
                                                <div style="margin-bottom: 30px;margin-top: -30px;">
                                                    <a href="<?php echo $home_url.'/profile/'.$rows->user_randid; ?>" target="_blank" class="view_profile"><button type="button" class="btn btn-outline-primary waves-effect waves-light btn-sm clone" title="Profile"><i class="mr-2" data-lucide="user-round" style="margin: 0 4px !important;"></i>My Profile&nbsp;&nbsp;</button></a>
                                                    <?php if($fundraiser_on=='1'){ ?>
                                                    <a href="<?php echo $home_url.'/referral/'.$rows->user_randid; ?>" target="_blank" class="view_profile"><button type="button" class="btn btn-outline-primary waves-effect waves-light btn-sm clone" title="Referral" style="margin-left:5px;"><i class="mr-2" data-lucide="link" style="margin: 0 4px !important;"></i>My Referral&nbsp;&nbsp;</button></a>
                                                    <?php } ?>
                                                </div>
                                                ...
                                                <div id="data_profile" style="margin-bottom: 70px;">
                                                    <div class="action-btn float-right">
                                                        <a href="javascript:;" class="edit_data_profile"><i class="text-info font-11" data-lucide="pen-line"></i><span class="text-icon">Edit</span></a>
                                                    </div>
                                                    ...
                                                    <h5 class="card-title mt-0" style="margin-top:5px;">Sapaan</h5>
                                                    <p class="card-text text-muted data_profile_show"><?php echo $rows->user_sapaan; ?></p>
                                                    <div class="form-group">
                                                        <?php 
                                                        if($sapaan_text_setting=='1'){
                                                        $sapaan_text_custom = explode(',', $sapaan_text_custom); ?>

                                                        <select class="form-control dyk_sapaan data_profile_hide" id="dyk_sapaan" name="sapaan" style="margin-bottom: 15px; display: inline-block;width:180px;">
                                                            <option value="">Pilih Sapaan</option>
                                                            <?php 
                                                            foreach($sapaan_text_custom as $key => $value){
                                                                $sapaan_selected='';
                                                                if($value==$rows->user_sapaan){$sapaan_selected='selected';}
                                                                echo '
                                                                <option value="'.$value.'" '.$sapaan_selected.'>'.$value.'</option>
                                                                ';
                                                            }
                                                            ?>
                                                        </select>
                                                        ...
                                                        <select class="form-control dyk_sapaan data_profile_hide" id="dyk_sapaan" name="sapaan" style="margin-bottom: 15px; display: inline-block;width:180px;">
                                                            <option value="">Pilih Sapaan</option>
                                                            <option value="Bapak" <?php if($rows->user_sapaan=='Bapak'){echo 'selected';}?>>Bapak</option>
                                                            <option value="Ibu" <?php if($rows->user_sapaan=='Ibu'){echo 'selected';}?>>Ibu</option>
                                                            <option value="Kak" <?php if($rows->user_sapaan=='Kak'){echo 'selected';}?>>Kak</option>
                                                        </select>
                                                        <?php } ?>
                                                    </div>
                                                    ...
                                                    */ ?>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <h5 class="card-title mt-0"><?php echo get_langArray('section_label1');?></h5><div class="spinner-border spinner-border-sm text-purple provinsi_loading kabkota_loading kecamatan_loading" role="status" style="position: absolute;margin-top: -30px;margin-left: 125px;display: none;"></div>

                                                        <?php if($rows->user_kecamatan=='') { ?>

                                                            <span class="data_profile_show">-</span>
                                                             <p class="card-text text-muted data_profile_show"></p>
                                                             <select class="form-control dyk_provinsi data_profile_hide" id="dyk_provinsi" name="provinsi" style="margin-bottom: 15px;">
                                                            </select>
                                                            
                                                            <select class="form-control dyk_kabkota data_profile_hide" id="dyk_kabkota" name="kabkota" style="margin-bottom: 15px;">
                                                            </select>
                                                            <select class="form-control dyk_kecamatan data_profile_hide" id="dyk_kecamatan" name="kecamatan" style="margin-bottom: 25px;">
                                                            </select>
                                                    ...
                                                    <?php }else{?>
                                                    <p class="card-text text-muted data_profile_show"><?php echo esc_html($rows->user_alamat); ?></p>
                                                    <div class="form-group data_profile_hide">
                                                        <textarea class="form-control" rows="3" id="user_alamat" style="font-size: 13px;"><?php echo esc_html($rows->user_alamat); ?></textarea>
                                                    </div>
                                                    <?php } ?>
                                                ...
                                                <div id="data_profile" style="margin-bottom: 70px;">
                                                    <div class="action-btn float-right">
                                                        <a href="javascript:;" class="edit_data_akun"><i class="text-info font-11" data-lucide="pen-line" style="margin-right:4px;"></i><span class="text-icon">Edit</span></a>
                                                    </div>
                                                    ...
                                                    <p class="card-text text-muted"><?php echo wp_get_current_user()->user_email; ?><span style="color: #ced4ec; font-style: italic;"> (tidak bisa diupdate)</span></p>
                                                ...
                                                <div class="action-btn float-right">
                                                    <a href="javascript:;" class="edit_data_bank"><i class="text-info font-11" data-lucide="pen-line" style="margin-right:4px;"></i><span class="text-icon">Edit</span></a>
                                                </div>
                                                <h4 class="card-title mt-0" id="bank">Data <?php echo get_langArray('section_label4');?> BANK</h4>
                                                <hr>
                                                ...
                                                <h5 class="card-title mt-0"><?php echo get_langArray('section_label2');?></h5>
                                                ...
                                                <h5 class="card-title mt-0"><?php echo get_langArray('section_label3');?></h5>
                                                ...
                                                <br>
                                                <div class="action-btn float-right">
                                                    <a href="javascript:;" class="edit_password"><i class="text-info font-11" data-lucide="pen-line" style="margin-right:4px;"></i><span class="text-icon">Edit Password</span></a>
                                                </div>
        ...
        <script>
            ...
            $('#upload_pp_image').click(function(e) {
                ...
                .on('select', function(e){
                    ...
                    .done(function() { 
                        ...
                        var data = {
                            "action": "dykfunction_update_pp_img",
                            "datanya": data_nya
                        };

                        jQuery.post(ajaxurl, data, function(response) {
                            if(response=='success'){
                                if (typeof dykToast === 'function') {
                                    dykToast('success', 'Foto profil berhasil diupdate.');
                                } else {
                                    swal.fire({
                                        toast: true,
                                        position: 'top-end',
            ...
            $('#upload_cover_image').click(function(e) {
                ...
                .on('select', function(e){
                    ...
                    .done(function() { 
                        ...
                        var data = {
                            "action": "dykfunction_update_cover_img",
                            "datanya": data_nya
                        };
                        ...
                        jQuery.post(ajaxurl, data, function(response) {
                            if(response=='success'){
                                if (typeof dykToast === 'function') {
                                    dykToast('success', 'Cover image berhasil diupdate.');
                                } else {
                                    swal.fire({
                                        toast: true,
                                        position: 'top-end',
                                        icon: 'success',
                                        title: 'Cover image berhasil diupdate.',
                                        showConfirmButton: false,
                                        timer: 2500,
                                        timerProgressBar: true
                                    });
            ...
            $('#update_password').bind("click", function(e){
                ...
                swal.fire({
                      ...
                      if (result.value) {
                        ...
                        var data = {
                            "action": "dykfunction_update_password",
                            "datanya": data_nya
                        };
                        ...
                        jQuery.post(ajaxurl, data, function(response) {
                            ...
                            if(response=='success'){
                                ...
                                if (typeof dykToast === 'function') {
                                    dykToast('success', 'Password berhasil diupdate.');
                                } else {
                                    swal.fire({
                                        toast: true,
                                        position: 'top-end',
            ...
            $('#update_data_akun').bind("click", function(e){
                ...
                var data = {
                    "action": "dykfunction_update_akun",
                    "datanya": data_nya
                };
                ...
                jQuery.post(ajaxurl, data, function(response) {
                    if(response=='success'){
                        if (typeof dykToast === 'function') {
                            dykToast('success', 'Data Akun Login berhasil diupdate.');
                        } else {
                            swal.fire({
                                toast: true,
                                position: 'top-end',
                                icon: 'success',
                                title: 'Data Akun Login berhasil diupdate.',
                                showConfirmButton: false,
                                timer: 2500,
                                timerProgressBar: true
                            });
            ...
            $('#update_data_akun_bank').bind("click", function(e){
                ...
                var data = {
                    "action": "dykfunction_update_akun_bank",
                    "datanya": data_nya
                };
                ...
                jQuery.post(ajaxurl, data, function(response) {
                    if(response=='success'){
                        if (typeof dykToast === 'function') {
                            dykToast('success', 'Data Akun Bank berhasil diupdate.');
                        } else {
                            swal.fire({
                                toast: true,
                                position: 'top-end',
                                icon: 'success',
                                title: 'Data Akun Bank berhasil diupdate.',
                                showConfirmButton: false,
                                timer: 2500,
                                timerProgressBar: true
                            });
            ...
            $('#update_data_profile').bind("click", function(e){
                ...
                var user_provinsi = $("#dyk_provinsi").find(":selected").val();
                var user_kabkota = $("#dyk_kabkota").find(":selected").val();
                var user_kecamatan = $("#dyk_kecamatan").find(":selected").val();

                var user_provinsi_id = $("#dyk_provinsi").find(":selected").data("idprovinsi");
                var user_kabkota_id = $("#dyk_kabkota").find(":selected").data("idkabkota");
                var user_kecamatan_id = $("#dyk_kecamatan").find(":selected").data("idkecamatan");

                var user_sapaan = $("#dyk_sapaan").find(":selected").val();
                ...
                var data = {
                    "action": "dykfunction_update_profile",
                    "datanya": data_nya
                };
                ...
                jQuery.post(ajaxurl, data, function(response) {
                    if(response=='success'){
                        if (typeof dykToast === 'function') {
                            dykToast('success', 'Data Profil berhasil diupdate.');
                        } else {
                            swal.fire({
                                toast: true,
                                position: 'top-end',
            ...
            function get_provinsi(id){
                ...
                $('select#dyk_provinsi').html('<option></option>');
                ...
                var data = {
                    "action": "dyk_get_provinsi",
                    "datanya": data_nya
                };

                jQuery.post(ajaxurl, data, function(response) {
                     $('select#dyk_provinsi').html(response);
            ...
            function get_kabkota(id){
                ...
                $('select#dyk_kabkota').html('<option></option>');
                ...
                var data = {
                    "action": "dyk_get_kabkota",
                    "datanya": data_nya
                };

                jQuery.post(ajaxurl, data, function(response) {
                     $('select#dyk_kabkota').html(response);
            ...
            function get_kecamatan(id){
                ...
                $('select#dyk_kecamatan').html('<option></option>');
            ...
            $('#upload_ktp_selfie').click(function(e) {
                ...
                .on('select', function(e){
                    ...
                    .done(function() { 
                        ...
                        var data = {
                            "action": "dykfunction_upload_ktp_selfie",
                            "datanya": data_nya
                        };
            ...
            $('#upload_legalitas').click(function(e) {
                ...
                .on('select', function(e){
                    ...
                    .done(function() { 
                        ...
                        $('#file_pdf_here').html('<a href="'+file_pdf+'" target="_blank" id="u_legalitas" data-file="'+file_pdf+'"><i class="text-danger" data-lucide="file-text"></i>&nbsp;&nbsp;&nbsp;'+filename+'</a>');
                        ...
                        var data = {
                            "action": "dykfunction_upload_legalitas",
                            "datanya": data_nya
                        };
            ...
            $(".submit_verification").click(function(e) {
                ...
                var data = {
                    "action": "dykfunction_submit_verification",
                    "datanya": data_nya
                };
...
function djavv(){ /* Telemetry ping neutralized for DonasiYuk fork */ }
