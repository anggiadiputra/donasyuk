...
function donasiyuk_dashboard() {
    ...
    <?php 
        ...
        $table_name7 = $wpdb->prefix . "dyk_custom_followup_scheduler ";
        $table_name8 = $wpdb->prefix . "dyk_group_list";
        $table_name9 = $wpdb->prefix . "dyk_group_data";
        $table_name10 = $wpdb->prefix . "dyk_aff_submit";
        $table_name11 = $wpdb->prefix . "dyk_aff_code";
    ...
    <style>
    /* =========================================================================
       CLASSIC & COMPACT DASHBOARD STYLES
       ========================================================================= */
    body {
    ...
    /* Filter Toolbar */
    .campaign_select, .select2-container--default .select2-selection--single {
    ...
    #datatables tbody tr:last-child td {
        border-bottom: none !important;
    }
    #datatables th.col-action, #datatables td.col-action {
    ...
    #datatables th.col-followup, #datatables td.col-followup {
        white-space: nowrap !important;
    }
    ...
    .col-action .btn-group .btn {
        padding: 3px 6px !important;
        font-size: 12px !important;
    }

    /* DataTables Controls (Search, Pagination, Length) */
    ...
    /* Payment Switch Specific (Dashboard & Tables) */
    .set_payment .custom-control-label span {
        font-size: 12px !important;
        font-weight: 600 !important;
        margin-left: 2px !important;
        line-height: 20px !important;
    }
    .set_payment.received .custom-control-input:checked ~ .custom-control-label::before,
    .set_payment .custom-control-input:checked ~ .custom-control-label::before {
        background-color: #16a34a !important;
        border-color: #15803d !important;
    }
    .set_payment.received .custom-control-label,
    .set_payment.received .custom-control-label span,
    .set_payment .custom-control-input:checked ~ .custom-control-label,
    .set_payment .custom-control-input:checked ~ .custom-control-label span {
        color: #16a34a !important;
        font-weight: 600 !important;
    }
    .set_payment.waiting .custom-control-input ~ .custom-control-label::before {
        background-color: #cbd5e1 !important;
        border-color: #94a3b8 !important;
    }
    .set_payment.waiting .custom-control-label,
    .set_payment.waiting .custom-control-label span {
        color: #64748b !important;
        font-weight: 600 !important;
    }
    
    /* Followup & Action Table Layout */
    .col-action {
        width: 70px !important;
    ...
    .btn-followup {
        ...
        border: 1px solid #1d68a7 !important;
        color: #ffffff !important;
    ...
    .btn-followup svg, .btn-followup i {
    ...
    <?php if($settings==true){ ?>
        ...
        jQuery(document).ready(function($){
            ...
            $('#update_text_followup').on("click", function(e) {
                ...
                var data = {
                    "action": "dykfunction_update_text_followup",
                    "datanya": data_nya
                };
                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard') ?>">Dashboard</a></li>
                                        ...
                                        <div class="card card-border" style="border: 0;padding: 0;">
                                            <div class="card-body">
                                                ...
                                                <div class="button-items mb-4">
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=settings') ?>"><button type="button" class="btn btn-primary waves-light">Follow-up Button & Format</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=automatic_followup') ?>"><button type="button" class="btn btn-outline-light">Automatic Followup</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group') ?>"><button type="button" class="btn btn-outline-light">Group</button></a>
                                                </div>
    ...
    <?php }elseif($automatic_followup==true){ ?>
        ...
        jQuery(document).ready(function($){
            ...
            $(document).on("change",".select_hour, .select_minute, .select_campaign, .select_status, .select_date, .select_schedule, .select_group",function(){
                ...
                var data = {
                    "action": "dykfunction_get_followup_time",
                    "datanya": data_nya
                };
                jQuery.post(ajaxurl, data, function(response) {
            ...
            $('#update_automatic_followup').on("click", function(e) {
                ...
                var data = {
                    "action": "dykfunction_update_automatic_followup",
                                    ...
                                    <div class="col-md-12 col-xl-12" style="margin-top: 0px;padding: 0;">
                                        <div class="card card-border" style="border: 0;padding: 0;">
                                            <div class="card-body">
                                                ...
                                                <div class="button-items mb-4">
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=settings') ?>"><button type="button" class="btn btn-primary btn-outline-light">Follow-up Button & Format</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=automatic_followup') ?>"><button type="button" class="btn btn-primary waves-light">Automatic Followup</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group') ?>"><button type="button" class="btn btn-outline-light">Group</button></a>
                                                </div>
                                                        ...
                                                        ?>
                                                            ...
                                                            <div id="scheduler_followup_<?php echo $no_scheduler;?>" class="row scheduler_followup  field_<?php echo $rand_id;?>" data-id="<?php echo $rand_id;?>" style="background: #F6FAFFA3;margin-left:0px;margin-right:0px;padding: 25px 30px 20px 30px;border: 1px solid #e3eaf4;border-radius: 4px;<?php if($automatic_followup_settings!='1'){ echo 'display:none;'; }?>">
                                                                    ...
                                                                    <div class="col-12 col_scheduler_left col_time" style="margin-bottom:30px !important;<?php if($value[0]!='on'){ echo 'display:none;'; }?>">
                                                                        ...
                                                                        <span>Hook : donasiyuk_f<?php echo $no_scheduler; ?>_event</span>
                                                                        </label>
                                                                        <br>
                                                                        <label>
                                                        ...
                                                        ?>
                                                            ...
                                                            <div id="custom_scheduler_<?php echo $followup->code_id; ?>" class="row custom_scheduler_followup field_c_<?php echo $followup->code_id; ?>" data-id="<?php echo $followup->code_id;?>" style="background: #F6FAFFA3;padding: 25px 30px 20px 30px;border: 1px solid #e3eaf4;border-radius: 4px;margin:0;margin-bottom: 15px;<?php if($automatic_followup_settings!='1'){ echo 'display:none;'; }?>">
                                                                    ...
                                                                    <div class="col-12 col_scheduler_left col_time row_c_<?php echo $followup->code_id; ?>" style="margin-top:5px;<?php if($followup->status!='on'){ echo 'display:none;'; }?>">
                                                                        <label>
                                                                        <span class="dashicons dashicons-update"></span>
                                                                        <span>Hook : donasiyuk_f<?php echo $no_followup; ?>_event_custom</span>
                                                                        </label>
                                                                        <br>
                                                                        <label>
                                                                        <span class="dashicons dashicons-clock"></span>
        ...
        jQuery(document).ready(function($){
            ...
            $('#datatables_group_list').DataTable( {
                ...
                "ajax": {
                    ...
                    "dataSrc": "data",
                    "data": {
                        action: 'dyk_get_group_list',
                        group_id: '<?php echo $group_id; ?>'
                    }
                },
                "buttons": [
                    {
                        text: '<i class="mr-1" data-lucide="plus" style="position:absolute;margin-left: -13px;"></i><span style="padding-left:5px;">Add&nbsp;Group</span>',
                        ...
                        action: function (e) {
                            ...
                            var data = {
                                "action": "dykfunction_get_group_list_name",
                                "datanya": data_nya
                            };
            ...
            $('#datatables_group').DataTable( {
                ...
                "buttons": [
                    {
                        text: '<i class="mr-1" data-lucide="plus" style="position:absolute;margin-left: -13px;"></i><span style="padding-left:5px;">Add&nbsp;Data</span>',
                        className: 'btn btn-success',
                        action: function (e) {
                            ...
                            var data = {
                                "action": "dykfunction_get_group_data_detail",
                                "datanya": data_nya
                            };
            ...
            $(document).on('click', '.edit_data', function(e){
                ...
                Swal.fire({
                      title: '<strong id="popup_title"><i data-lucide="file-text" style="width:18px;height:18px;color:#2563eb;margin-right:6px;vertical-align:-2px;"></i> Data Detail</strong>',
                      icon: false,
                      showConfirmButton: false,
                      width: '820px',
                      html:
                        '<div id="data_box" style="margin-bottom:30px;"><div class="dyk-modal-loading-box"><div class="dyk-loading-icon-wrapper"><i data-lucide="loader-2" class="dyk-lucide-spin"></i></div><div class="dyk-loading-text">Memuat Data Group...</div><div class="dyk-loading-subtext">Mengambil rincian data group</div></div></div>',
                      showCloseButton: true,
                      didOpen: function() {
            ...
            $(document).on('click', '.update_group_name', function(e){
                ...
                var data = {
                    "action": "dykfunction_update_group_name",
                    "datanya": data_nya
                };
                ...
                jQuery.post(ajaxurl, data, function(response) {
                    ...
                    if(response_info=='success' && id=='0'){
                        ...
                        $('#datatables_group_list tbody').prepend('<tr id="group_4" role="row" class="odd"><td class="sorting_1"><span data-id="4"></span></td><td><a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group&')?>id='+response_id+'">'+group_name+'</a></td><td>0</td><td><div class="btn-group" role="group"><a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group&')?>id='+response_id+'"><button type="button" class="btn btn-outline-light group_detail" data-id="'+response_id+'" title="Data Detail" style="border-top-right-radius:0;border-bottom-right-radius:0;"><i class="mr-2" data-lucide="file-text" style="margin: 0 4px 0 2px !important;color:#7680FF;"></i></button></a><button type="button" class="btn btn-outline-light del_group" data-id="'+response_id+'" title="Delete"><i class="mr-2" data-lucide="trash-2" style="margin: 0 4px 0 2px !important;color:#EF4D56;"></i></button></div></td></tr>');
            ...
            $(document).on('click', '.update_group_data_detail', function(e){
                ...
                var data = {
                    "action": "dykfunction_update_group_data_detail",
                    "datanya": data_nya
                };
            ...
            if(isset($_GET['id'])){ 
                ...
                if($data_group!=null){
                    ...
                    // $group_name = '-';
                    echo 'window.location.href = "'.admin_url('admin.php?page=donasiyuk_dashboard&action=group').'";';
                }
            }else{
                $group_id = '';
            }
            ...
            $(document).on("click", ".del_data", function(e) {
                ...
                swal.fire({
                  ...
                  if (result.value) {
                    ...
                    var data = {
                        "action": "dykfunction_del_data_group",
                        "datanya": data_nya
                    };
            ...
            $(document).on("click", "#delete_data_group", function(e) {
                ...
                swal.fire({
                  ...
                  if (result.value) {
                    ...
                    var data = {
                        "action": "dykfunction_del_data_group_only",
                        "datanya": data_nya
                    };
            ...
            $(document).on("click", ".del_data_group_all", function(e) {
                ...
                swal.fire({
                  ...
                  if (result.value) {
                    ...
                    var data = {
                        "action": "dykfunction_del_data_group_all",
                        "datanya": data_nya
                    };
                                    ...
                                    <div class="col-md-12 col-xl-12" style="margin-top: 0px;padding: 0;">
                                        <div class="card card-border" style="border: 0;padding: 0;">
                                            <div class="card-body">
                                                ...
                                                <div class="button-items mb-4">
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=settings') ?>"><button type="button" class="btn btn-outline-light">Follow-up Button & Format</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=automatic_followup') ?>"><button type="button" class="btn btn-primary btn-outline-light">Automatic Followup</button></a>
                                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group') ?>"><button type="button" class="btn btn-primary waves-light">Group</button></a>
                                                </div>
                                                                ...
                                                                <div class="card-body" style="background: #f1f5fa;">
                                                                    <div class="row">
                                                                        <div class="col-6 align-self-center">
                                                                           <div class="media">
                                                                                ...
                                                                                <div class="icon-info align-self-center" style="background: white;padding: 8px;border-radius: 20px;">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="align-self-center icon-lg icon-dual-purple" data-lucide="users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>

                                                                                </div> 

                                                                                <div class="media-body align-self-center">

                                                                                    <h4 class="mt-0 mb-2 font-16" style="margin-left: 10px;padding-top: 8px;"><a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=group') ?>" style="color: #7680ff;">Group</a> / <span id="data_group_name"><?php echo $group_name; ?></span> 

                                                                                        <i class="text-info font-16 dashicons-edit edit_group_name" data-lucide="pencil" data-id="<?php echo $group_id; ?>" style="cursor:pointer;font-size: 14px !important;margin-left: 5px;"></i>
                                                                                    </h4>
                                                                        ...
                                                                        <div class="col-6 align-self-center text-right" style="padding-right:0;">
                                                                            <div class="ml-2">
                                                                                <button class="btn btn-danger float-right" id="delete_data_group" data-id="<?php echo $group_id; ?>" data-gname="<?php echo $group_name; ?>" title="Delete Data on Group" style="padding: 3px 12px 3px 7px;font-size: 10px;margin-right: 10px;width: auto;"><i class="mr-1" data-lucide="trash-2"></i>Empty</button>
                                                                                <button class="btn btn-outline-primary float-right" id="import_data" data-id="<?php echo $group_id; ?>" data-gname="<?php echo $group_name; ?>" title="Delete Group" style="padding: 3px 12px 3px 7px;font-size: 10px;margin-right: 5px;width: 65px;"><i class="mr-1" data-lucide="arrow-down-square"></i>Import</button>
                                                                            </div>
                                                                        </div>                    
                                                                    </div>
                                                                </div><!--end card-body-->
                                                            ...
                                                            <table class="table_shortcode" style="margin-bottom:30px;">
                                                                <tbody>
                                                                    <ol style="margin-left: 12px;">
                                                                        <li><a href="<?php echo admin_url('admin-post.php?action=download_template_excel2') ?>" targe="_blank"><i data-lucide="table" style="margin-right:3px;"></i>Download Template Table - Data Group</a></li>
    ...
    <?php }elseif($trash==true){ ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                ...
                                <div class="card-body">
                                    <div><button class="btn btn-danger px-3 float-right mt-0 mb-2" id="delete_all_trash"><i class="mr-2" data-lucide="trash-2"></i>Delete All Trash</button></div>
        ...
        jQuery(document).ready(function($){
            ...
            $(document).on('click', '.detail_donasi', function(e){
                ...
                Swal.fire({
                      ...
                      width: '780px',
                      html:
                        '<div id="data_box"><div class="dyk-modal-loading-box"><div class="dyk-loading-icon-wrapper"><i data-lucide="loader-2" class="dyk-lucide-spin"></i></div><div class="dyk-loading-text">Memuat Detail Donasi...</div><div class="dyk-loading-subtext">Mengambil rincian transaksi & donatur</div></div></div>',
                      showCloseButton: true,
                      didOpen: function() {
                        if (window.lucide && typeof lucide.createIcons === "function") { lucide.createIcons(); }
                      },
            ...
            $(document).on('click', '.restore_data', function(e){
                ...
                var data = {
                    "action": "dykfunction_restore_data",
                    "datanya": data_nya
                };
        ...
        $(document).on("click",".btn-ip-blocked",function(){
            ...
            $(document).on("click",".btn-whatsapp-blocked",function(){
                ...
                var data = {
                    "action": "dykfunction_blocked_whatsapp",
                    "datanya": data_nya
                };
            ...
            $(document).on("click",".btn-whatsapp-open",function(){
                ...
                var data = {
                    "action": "dykfunction_open_whatsapp",
                    "datanya": data_nya
                };
        ...
        $(document).on("click", ".del_donasi", function(e) {
            ...
            swal.fire({
              ...
              if (result.value) {
                ...
                var data = {
                    "action": "dykfunction_del_donasi_trash",
                    "datanya": data_nya
                };
        ...
        $(document).on("click", "#delete_all_trash", function(e) {
            ...
            swal.fire({
              ...
              if (result.value) {
                ...
                var data = {
                    "action": "dykfunction_del_donasi_trash_all",
                    "datanya": data_nya
                };
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="page-title-box">
                                ...
                                <div class="button-items mb-1">
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=ipblocked');?>"><button type="button" class="btn btn-primary waves-light">IP Blocked</button></a>
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=ipwhitelist');?>"><button type="button" class="btn btn-outline-light">IP Whitelist</button></a>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div><button class="btn btn-danger px-3 float-right mt-0 mb-2" id="delete_all_ip"><i class="mr-1" data-lucide="trash-2"></i>Delete All IP</button></div>

                                    <div><button class="btn btn-success px-3 float-right mt-0 mb-2 mr-2" id="add_new_ip"><i class="mr-1" data-lucide="plus"></i>Add New IP</button></div>
...
/*             padding-bottom: 0px; */
        ...
        $(document).on("click", ".edit_ip", function (e) {
            ...
            var data = {
                action: "dykfunction_get_data_ip",
                datanya: [id]
            };
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-title-box">
                                ...
                                <div class="button-items mb-1">
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=ipblocked');?>"><button type="button" class="btn btn-outline-light">IP Blocked</button></a>
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=ipwhitelist');?>"><button type="button" class="btn btn-primary waves-light">IP Whitelist</button></a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <div class="button-items mb-1">
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=wablocked');?>"><button type="button" class="btn btn-primary waves-light">WA Blocked</button></a>
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=wawhitelist');?>"><button type="button" class="btn btn-outline-light">WA Whitelist</button></a>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div><button class="btn btn-danger px-3 float-right mt-0 mb-2" id="delete_all_wa"><i class="mr-1" data-lucide="trash-2"></i>Delete All WA</button></div>

                                    <div><button class="btn btn-success px-3 float-right mt-0 mb-2 mr-2" id="add_new_wa"><i class="mr-1" data-lucide="plus"></i>Add New WA</button></div>
...
/*             padding-bottom: 0px; */
        ...
        $(document).on("click", ".edit_wa", function (e) {
            ...
            var data = {
                action: "dykfunction_get_data_wa",
                datanya: [id]
            };
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <div class="button-items mb-1">
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=wablocked');?>"><button type="button" class="btn btn-outline-light">WA Blocked</button></a>
                                    <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=wawhitelist');?>"><button type="button" class="btn  btn-primary waves-light">WA Whitelist</button></a>
                                </div>
                ...
                <div class="container-fluid">    
                    ...
                    <?php 
                        ...
                        if(isset($_GET['id'])){
                            ...
                            if ($get_title==null) {
                               $titlenya = 'Show All'.$referral_name;
                            }else{
                                $titlenya = $get_title[0]->title.$referral_name;
                            }
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-sm-12" style="margin-bottom: 10px;">
                            ...
                            <div class="page-title-box" style="padding-top: 10px;">
                                    ...
                                    <div class="float-right d-flex justify-content-between">
                                        ...
                                        <div id="by_date_box" class="btn-group ml-1" style="background: #fff;">
                                            ...
                                            <div id="by_date_list" class="dropdown-menu" style="<?php if($role=='donatur' || $role=='cs'){echo 'margin-left:-108px;}';}?>">
                                                <?php if(isset($_GET['id'])){ ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=today'.$filer_by_aff_user_id;?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=yesterday'.$filer_by_aff_user_id;?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=7lastdays'.$filer_by_aff_user_id;?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=30lastdays'.$filer_by_aff_user_id;?>">30 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=thismonth'.$filer_by_aff_user_id;?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=lastmonth'.$filer_by_aff_user_id;?>">Last Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thisyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=thisyear'.$filer_by_aff_user_id;?>">This Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=lastyear'.$filer_by_aff_user_id;?>">Last Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last2years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=last2years'.$filer_by_aff_user_id;?>">Last 2 Years</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last3years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=last3years'.$filer_by_aff_user_id;?>">Last 3 Years</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=daterange'.$filer_by_aff_user_id;?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=').$_GET['id'].'&date=all'.$filer_by_aff_user_id;?>">All</a>
                                                <?php } else { ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=today'.$filer_by_aff_user_id;?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=yesterday'.$filer_by_aff_user_id;?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=7lastdays'.$filer_by_aff_user_id;?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=30lastdays'.$filer_by_aff_user_id;?>">30 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=thismonth'.$filer_by_aff_user_id;?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=lastmonth'.$filer_by_aff_user_id;?>">Last Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thisyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=thisyear'.$filer_by_aff_user_id;?>">This Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=lastyear'.$filer_by_aff_user_id;?>">Last Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last2years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=last2years'.$filer_by_aff_user_id;?>">Last 2 Years</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last3years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=last3years'.$filer_by_aff_user_id;?>">Last 3 Years</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=daterange'.$filer_by_aff_user_id;?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard').'&date=all'.$filer_by_aff_user_id;?>">All</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div id="by_date_box2" class="btn-group ml-1" style="background: #fff;">
                                            <button id="by_download_button" type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                <i class="mr-1" data-lucide="download"></i>Download<i class="ml-1" data-lucide="chevron-down"></i>
                                            </button>
                                        ...
                                        <div class="btn-group ml-1" style="background: #fff;">
                                            <button id="upload_donasi" type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="height: 32px;" <?php if($c_id=='all'){ echo 'disabled="" title="Pilih Campaign terlebih dahulu"';}else{echo 'title="Upload Data Donasi" data-ctitle="'.$titlenya.'" data-cid="'.$c_id.'"';}?>>
                                                <i class="mr-1" data-lucide="upload"></i>Upload Data
                                            </button>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <?php if($role=='donatur' || $role=='cs'){ } else { ?>
                                        <!-- <div class="btn-group ml-1" style="background: #fff;">
                                            <a href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=settings');?>" data-id="<?php echo $c_id; ?>">
                                            <button type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect" style="height: 32px;" title="Settings Follow-up">
                                                <i class="mr-1" data-lucide="users"></i>Follow-up WA</button>
                                            </a>
                                        </div> -->
                                        ...
                                        <div id="by_setting_box" class="btn-group ml-1" style="background: #fff;">
                                            <button id="by_setting_button" type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                <i data-lucide="settings"></i>&nbsp;&nbsp;Options<i class="ml-1" data-lucide="chevron-down"></i>
                                            </button>
                                            
                                            <div id="by_setting_list" class="dropdown-menu" style="display: none;">
                                                <a class="dropdown-item download_donasi" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=trash');?>" data-id="<?php echo $c_id; ?>" data-date="<?php echo $c_date; ?>" data-range="<?php echo $c_range; ?>" data-status="success">Data Trash</a>
                                                <a class="dropdown-item download_donasi" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=ipblocked');?>">IP Blocked</a>
                                                <a class="dropdown-item download_donasi" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=wablocked');?>">WA Blocked</a>
                                                <a class="dropdown-item download_donasi" href="<?php echo admin_url('admin.php?page=donasiyuk_dashboard&action=settings');?>" data-id="<?php echo $c_id; ?>">Follow-up WA</a>
                                            </div>
                                ...
                                <h4 class="page-title"><i data-lucide="file"></i><span class="dash-title"><?php echo $titlenya; ?></span></h4>
                            </div><!--end page-title-box-->
                        </div>
                            ...
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body" style="padding: 16px 20px;">
                                    <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                                        <div>
                                            <h5 class="mb-0 font-15 font-weight-bold text-dark">Data Analytics - <?php echo $fullname; ?></h5>
                                            <p class="text-muted font-12 mb-0"><?php echo get_langArray('dash_cs_desc1');?> <?php echo $titlenya; ?></p>
                                        </div>
                                        <div class="dyk-stat-badge badge-blue">
                                            <i data-lucide="bar-chart-2"></i>
                                        </div>
                                    </div>
                                    <div id="box_stat_cs" class="row">
                                        <div class="col-lg-3 col-md-6 border-right">
                                            <div class="dyk-stat-label"><?php echo get_langArray('dash_cs_desc2');?></div>
                                            <div class="dyk-stat-value font-20"><?php echo $show_currency2; ?><span id="totalDonasiCS">...</span></div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 border-right">
                                            <div class="dyk-stat-label"><?php echo get_langArray('dash_cs_desc3');?></div>
                                            <div class="dyk-stat-value font-20"><span id="jumlahDonasiCS">...</span></div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 border-right">
                                            <div class="dyk-stat-label"><?php echo get_langArray('dash_cs_desc4');?></div>
                                            <div class="dyk-stat-value font-20"><span id="jumlahDonasiTerkumpulCS">...</span></div>
                                        </div>
                                        <div class="col-lg-3 col-md-6">
                                            <div class="dyk-stat-label"><?php echo get_langArray('dash_cs_desc5');?></div>
                                            <div class="dyk-stat-value font-20"><span id="konversiCS">...</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-total-donasi">
                            <div class="card dyk-compact-stat-card card-stat-total <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label"><?php echo get_langArray('dash_card_title1');?></span>
                                        <div class="dyk-stat-badge badge-emerald">
                                            <i data-lucide="heart"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value">
                                        <?php echo $show_currency2; ?><span id="totalDonasi">...</span>
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span><?php echo get_langArray('dash_card_desc1');?></span>
                                    </div>
                                </div>
                            </div>
                        </div>  
                        <div class="col-lg-4 col-jumlah-donasi">
                            <div class="card dyk-compact-stat-card card-stat-jumlah <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label"><?php echo get_langArray('dash_card_title2');?></span>
                                        <div class="dyk-stat-badge badge-blue">
                                            <i data-lucide="trophy"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value">
                                        <span id="jumlahDonasi">...</span>
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span id="jumlahDonasiTerkumpul">...</span>
                                    </div>
                                </div>
                            </div>
                        </div>  
                        <div class="col-lg-4 col-konversi-donasi">
                            <div class="card dyk-compact-stat-card card-stat-konversi <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label"><?php echo get_langArray('dash_card_title3');?></span>
                                        <div class="dyk-stat-badge badge-purple">
                                            <i data-lucide="pie-chart"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value">
                                        <span id="konversi">...</span>
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span><?php echo get_langArray('dash_card_desc4');?></span>
                                    </div>
                                </div>
                            </div>
                        </div>  
                        ...
                        <div class="col-12">
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                <div class="card-body">
                                    ...
                                    <!-- <i class="float-right mt-0 mb-3 edit_table" data-lucide="square-pen" title="Edit kolom table"></i> -->
                                    <!-- <br> -->
                                    <br>
                                    <div class="table-responsive dash-social">
                                        <?php
                                        ...
                                        <table id="datatables" class="table">
                                            ...
                                            <tr>
                                                    ...
                                                    <th>Payment</th> 
                                                    <?php if($role!='donatur'){ ?>
                                                    <th style="<?php echo $width; ?> white-space: nowrap;">Followup</th>
                                                    <?php } ?>                                 
                                                    <th>Date</th>
                                                    <?php  if($role=='donatur' || $role=='cs'){}else{ ?>
                                                    <th style="width: 70px; min-width: 70px; max-width: 80px; text-align: center;">Action</th>
                                                    <?php  } ?> 
                                                </tr>
                                            </thead>
        ...
        jQuery(document).ready(function($){
            ...
            $('#datatables').DataTable( {
                ...
                "columns": [
                    ...
                    { "data": "cs" },
                    <?php } ?>
                    { "data": "payment_status", "className": "col-payment" },
                    <?php if($role!='donatur'){ ?>
                    { "data": "followup", "className": "col-followup" },
                    <?php } ?>
                    { "data": "date" },
                    <?php  if($role=='donatur' || $role=='cs'){}else{ ?>
                    { "data": "action", "className": "col-action text-center" }
                    <?php } ?>
                ],
                "lengthMenu": [
                    [ 10, 25, 50, 100, -1 ],
            ...
            $(document.body).on("change",".campaign_select",function(){
                var c_id = (this.value);
                if(c_id=='show_all'){
                    var url = "<?php echo admin_url('admin.php?page=donasiyuk_dashboard');?>";
                }else{
                    var url = "<?php echo admin_url('admin.php?page=donasiyuk_dashboard&id=');?>"+c_id;
                }
            ...
            $(document).on('click', '.update_donasi', function(e){
                ...
                var data = {
                    "action": "dykfunction_update_donasi",
                    "datanya": data_nya
                };
                jQuery.post(ajaxurl, data, function(response) {
                    ...
                    if ($("#edit_data_donasi .select2").hasClass("opt_active")) {
                        if(pp!=''){
                            ...
                            var pp = '<?php echo plugin_dir_url( __FILE__ ) . "../assets/images/pp.svg"; ?>';
                            $('#pp_'+id_donasi).attr('src',pp);
            ...
            $(document).on('change', '.set_payment_status', function(e){
                ...
                var data = {
                    "action": "dykfunction_set_payment",
                    "datanya": data_nya
                };
                jQuery.post(ajaxurl, data, function(response) {
            ...
            $(document).on('click', '.detail_donasi', function(e){
                ...
                if($(this).hasClass("img_confirmation")){
                    Swal.fire({
                          title: '<strong id="popup_title"><i data-lucide="image" style="width:18px;height:18px;color:#2563eb;margin-right:6px;vertical-align:-2px;"></i> Data Konfirmasi</strong>',
                          icon: false,
                          width: '520px',
                          html:
                            '<div id="data_box"><div class="dyk-modal-loading-box"><div class="dyk-loading-icon-wrapper"><i data-lucide="loader-2" class="dyk-lucide-spin"></i></div><div class="dyk-loading-text">Memuat Bukti Transfer...</div><div class="dyk-loading-subtext">Mengambil data konfirmasi pembayaran</div></div></div>',
                          showCloseButton: true,
                          didOpen: function() {
                            if (window.lucide && typeof lucide.createIcons === "function") { lucide.createIcons(); }
                          },
                    ...
                    var data = {
                        "action": "dykfunction_get_donasi_confirmation",
                        "datanya": data_nya
                    };
                    ...
                    jQuery.post(ajaxurl, data, function(response) {
                        ...
                        $('#data_box').html('<div class="dyk-modal-error-box"><div class="dyk-error-icon-wrapper"><i data-lucide="alert-circle"></i></div><div class="dyk-loading-text">Gagal Memuat Bukti</div><div class="dyk-loading-subtext">Koneksi jaringan terputus. Silakan coba lagi.</div></div>');
                        if (window.lucide && typeof lucide.createIcons === "function") { lucide.createIcons(); }
                    });
                }
            });
            ...
            $(document).on('click', '.del_conf', function(e){
                ...
                swal.fire({
                  ...
                  if (result.value) {
                    ...
                    var data = {
                        "action": "dykfunction_del_confirmation",
                        "datanya": data_nya
                    };
        ...
        $(document).on("click", ".btn-followup", function(e) {
            ...
            jQuery.post(ajaxurl, data, function(response) {
                ...
                if(response.length<=7){
                    ...
                    $('.followup'+followup_number).find("i, svg").show();
                    $('.followup'+followup_number).find(".spinner-border").remove();
                }else{
                    // redirect WA
                    $('.followup'+followup_number).find("i, svg").show();
