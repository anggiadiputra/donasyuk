...
function donasiyuk_data_fundraising() { ?>
    <?php 
    global $wpdb;
    ...
    $table_name9 = $wpdb->prefix . "dyk_aff_submit";
    $table_name10 = $wpdb->prefix . "dyk_aff_click";
    $table_name11 = $wpdb->prefix . "dyk_aff_payout";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12" style="margin-bottom: 20px;">
                            ...
                            <?php if($as_user==true) { ?>
                                <h4 class="page-title"><i data-lucide="user"></i><span class="dash-title">As User</span></h4>
                            <?php }else{ ?>
                                <h4 class="page-title"><i data-lucide="user"></i><span class="dash-title">As Administrator</span></h4>
                            <?php } ?>
                            </div><!--end page-title-box-->
                            <div class="btn-group ml-1 option_campaign" style="position: absolute;right: 0;margin-top: -20px;margin-right: 10px;">
                                <button type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Dasboard<i class="ml-1" data-lucide="chevron-down"></i>
                                </button>
                                <div class="dropdown-menu dropdown-menu-left" style="position: absolute; transform: translate3d(-130.633px, 32.7167px, 0px); top: 0px; left: 46px; will-change: transform;" x-placement="bottom-end">
                                    <a class="dropdown-item"href="<?php echo admin_url('admin.php?page=donasiyuk_data_fundraising')?>">As Administrator</a>
                                    <a class="dropdown-item no-border" href="<?php echo admin_url('admin.php?page=donasiyuk_data_fundraising&as=user')?>">As User</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" <?php if($show_referral==true){echo'style="display:none;"';}?>> 
                            ...
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label"><?php echo get_langArray('fundraising_section_title1');?></span>
                                        <div class="dyk-stat-badge badge-emerald">
                                            <i data-lucide="heart"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value" id="totalFundraising">
                                        ...
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span><?php echo get_langArray('fundraising_section_desc1');?></span>
                                    </div>
                                </div>
                            </div>
                        </div>  
                        <div class="col-lg-3 col-jumlah-donasi">
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label"><?php echo get_langArray('fundraising_section_title2');?></span>
                                        <div class="dyk-stat-badge badge-blue">
                                            <i data-lucide="trophy"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value" id="komisiFundraising">
                                        ...
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span><?php echo get_langArray('fundraising_section_desc2');?></span>
                                    </div>
                                </div>
                            </div>
                        </div>  
                        <div class="col-lg-6">
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body" style="padding: 16px 20px;">
                                    <div class="row">
                                        <div class="col-md-4 border-right section_balance"> 
                                            <span class="dyk-stat-label"><?php echo ($role=='administrator' && $as_user!=true) ? 'User Balance' : 'Balance'; ?></span>
                                            <div class="dyk-stat-value" style="font-size: 18px;" id="komisiBelumCair">...</div>
                                            <div class="mt-2">
                                                <?php if($belum_dicairkan=='0') { ?>
                                                    <button disabled="" type="button" class="btn btn-sm btn-outline-secondary" title="Cairkan Sekarang">Cairkan</button>
                                                <?php }else{ ?>
                                                    <button id="cairkan_sekarang" type="button" class="btn btn-sm btn-primary" title="Cairkan Sekarang" data-cairkan="<?php echo $show_currency2; ?><?php echo number_format_currency($belum_dicairkan); ?>" data-belumcair="<?php echo $belum_dicairkan; ?>">Cairkan</button>
                                                <?php } ?>
                                            </div>
                                        </div>    
                                        <div class="col-md-4 border-right section_on_process">     
                                            <span class="dyk-stat-label">On Process</span>
                                            <div class="dyk-stat-value text-warning" style="font-size: 18px; color: #d97706 !important;" id="komisiProsesCair">...</div>
                                            <div class="mt-2">
                                                <button id="on_process" type="button" class="btn btn-sm btn-outline-primary" title="List Pencairan">Detail</button>
                                            </div>
                                        </div>    
                                        <div class="col-md-4 section_paid">     
                                            <span class="dyk-stat-label">Paid</span>
                                            <div class="dyk-stat-value text-success" style="font-size: 18px; color: #059669 !important;" id="komisiCair">...</div>
                                            <div class="mt-2">
                                                <button id="list_pencairan" type="button" class="btn btn-sm btn-outline-primary" title="Detail Pencairan">Detail</button>
                                            </div>
                                        </div>      
                                    </div>
                                </div>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-4 col-jumlah-donasi">
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label">Success Fundraising</span>
                                        <div class="dyk-stat-badge badge-blue">
                                            <i data-lucide="trophy"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value" id="successFundraising">
                                        ...
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span>Fundraising yang berhasil sampai payment</span>
                                    </div>
                                </div>
                            </div>
                        </div> 
                        <div class="col-lg-4 col-jumlah-donasi">
                            <div class="card dyk-compact-stat-card <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="dyk-stat-label">Link Fundraising</span>
                                        <div class="dyk-stat-badge badge-purple">
                                            <i data-lucide="link"></i>
                                        </div>
                                    </div>
                                    <div class="dyk-stat-value" id="linkFundraising">
                                        ...
                                    </div>
                                    <div class="dyk-stat-subtext">
                                        <span>Jumlah link fundraising yang aktif</span>
                                    </div>
                                </div>
                            </div>
                        </div>                   
                                    ...
                                    <?php if($role=='administrator') { ?>
                                        <?php if($as_user==true) { ?>
                                            <?php if($show_referral==true) { ?>
                                                ...
                                                <?php if($as_user==true) { ?>
                                                    <h4 class="header-title mt-0"><a href="<?php echo admin_url('admin.php?page=donasiyuk_data_fundraising');?>&as=user" target="_self" style="">My Fundraising</a> / <?php echo $title_campaignya; ?></h4> 
                                                <?php }else{ ?>
                                                    <h4 class="header-title mt-0"><a href="<?php echo admin_url('admin.php?page=donasiyuk_data_fundraising');?>" target="_self" style="">My Fundraising</a> / <?php echo $title_campaignya; ?></h4> 
                                                <?php } ?>
                                        ...
                                        <?php }else{ ?>
                                            <?php if($show_referral==true) { ?>
                                                ...
                                                <h4 class="header-title mt-0"><a href="<?php echo admin_url('admin.php?page=donasiyuk_data_fundraising');?>" target="_self" style="">Data Fundraising</a> / <?php echo $title_campaignya; ?></h4> 
                        ...
                        <div class="col-12">
                            <div class="card  <?php if($app_name=='HAMBA ALLAH'){echo'detected';}?>" style="max-width: 100%;">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <button id="close_on_process" type="button" title="Close" style="position: absolute;font-size: 10px;padding-left: 15px;padding-right: 15px;margin-left:100px;float: right;right: 0;margin-right: 45px;margin-top: -30px;" class="btn btn-outline-danger waves-effect waves-light btn-sm">Close<i data-lucide="x" style="margin-left: 3px;"></i></button>
                                    </div>
                                    <br><br>
                                    <div class="table-responsive dash-social">
        ...
        <script>
            ...
            $('#datatable_fundraising').DataTable( {
                ...
                "ajax": {
                    ...
                    "dataSrc": "data",
                    "data": {
                        action: 'dyk_get_data_fundraising',
            ...
            $('#datatable_on_process').DataTable( {
                ...
                "ajax": {
                    ...
                    "dataSrc": "data",
                    "data": {
                        action: 'dyk_get_data_fundraising_on_process',
                        as_user: '<?php echo $as_user; ?>',
                        statusnya: 0,
                        date_filter: '',
                        date_range: '',
            ...
            $(document).on("click", ".delete_pencairan", function(e) {
                ...
                swal.fire({
                  ...
                  if (result.value) {
                    ...
                    var data = {
                        "action": "dykfunction_delete_pencairan",
                        "datanya": data_nya
                    };
            ...
            $(document).on('submit', 'form#form_update_status_payment', function(e){
                ...
                var data = {
                    "action": "dykfunction_update_status_payment",
                    "datanya": data_nya
                };
            ...
            $(document).on('submit', 'form#form_cairkan_sekarang', function(e){
                ...
                var data = {
                    "action": "dykfunction_cairkan_sekarang",
                    "datanya": data_nya
                };
                ...
                jQuery.post(ajaxurl, data, function(response) {
                    ...
                    if(response=='success'){
                        ...
                        swal.fire(
                          'Failed!',
                          'Silahkan isi terlebih dahulu data akun Bank anda!<br><a href="<?php echo admin_url('admin.php?page=donasiyuk_myprofile#bank')?>"><button type="button" class="btn btn-outline-secondary waves-effect" style="margin-top: 20px;"><i data-lucide="landmark" style="margin-right:6px;"></i>Bank Account</button></a>',
                          'warning'
                        );
                    }else{
                        swal.fire(
...
function aoa2(){ /* Telemetry ping neutralized for DonasiYuk fork */ }