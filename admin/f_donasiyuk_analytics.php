...
function donasiyuk_data_analytics() {
    ?>
    <?php 
    ...
    <style>
    /* =========================================================================
       CLASSIC & COMPACT ANALYTICS STYLES
       ========================================================================= */
    body {
    ...
    <?php wp_die(); } } ?>
                                        ...
                                        <div id="by_date_box" class="btn-group ml-1">
                                            ...
                                            <div id="by_date_list" class="dropdown-menu" style="<?php if($role=='donatur' || $role=='cs'){echo 'margin-left:-108px;}';}?>">
                                                ...
                                                <?php if(isset($_GET['id'])){ ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=today';?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=yesterday';?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=7lastdays';?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=30lastdays';?>">30 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=thismonth';?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=lastmonth';?>">Last Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thisyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=thisyear';?>">This Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=lastyear';?>">Last Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last2years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=last2years';?>">Last 2 Years</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last3years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=last3years';?>">Last 3 Years</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').$idnya.'&date=daterange';?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=').'&date=all';?>">All</a>
                                                <?php } else { ?>
                                                    <a class="dropdown-item <?php if($date_filter_title=='today'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=today';?>">Today</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='yesterday'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=yesterday';?>">Yesterday</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='7lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=7lastdays';?>">7 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='30lastdays'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=30lastdays';?>">30 Last days</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thismonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=thismonth';?>">This Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastmonth'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=lastmonth';?>">Last Month</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='thisyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=thisyear';?>">This Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='lastyear'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=lastyear';?>">Last Year</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last2years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=last2years';?>">Last 2 Years</a>
                                                    <a class="dropdown-item <?php if($date_filter_title=='last3years'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=last3years';?>">Last 3 Years</a>
                                                    <a class="dropdown-item daterange <?php if($date_filter_title=='daterange'){echo'active';}?>" href="javascript:;" data-link="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=daterange';?>">Date Range</a>
                                                    <a class="dropdown-item <?php if($date_filter_title==null || $date_filter_title=='all'){echo'active';}?>" href="<?php echo admin_url('admin.php?page=donasiyuk_data_analytics').'&date=all';?>">All</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card dyk-compact-stat-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="dyk-stat-label">Success</span>
                                                <div class="dyk-stat-badge badge-emerald">
                                                    <i data-lucide="check-circle-2"></i>
                                                </div>
                                            </div>
                                            <div class="dyk-stat-value" id="jumlahSuccess">
                                                ...
                                            </div>
                                            <div class="dyk-stat-subtext">
                                                <span id="totalSuccessNominal" style="font-weight: 600; color: #059669;">...</span>
                                            </div>
                                        </div>                                      
                                    </div>                                      
                                </div><!-- end col-->
                                <div class="col-lg-3">
                                    <div class="card dyk-compact-stat-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="dyk-stat-label">Waiting</span>
                                                <div class="dyk-stat-badge badge-rose">
                                                    <i data-lucide="clock"></i>
                                                </div>
                                            </div>
                                            <div class="dyk-stat-value" id="jumlahWaiting">
                                                ...
                                            </div>
                                            <div class="dyk-stat-subtext">
                                                <span id="totalWaitingNominal" style="font-weight: 600; color: #e11d48;">...</span>
                                            </div>
                                        </div>                                      
                                    </div>                                      
                                </div><!-- end col-->
                                <div class="col-lg-3">
                                    <div class="card dyk-compact-stat-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="dyk-stat-label">Total</span>
                                ...
                                <div class="col-lg-3">
                                    <div class="card dyk-compact-stat-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <span class="dyk-stat-label">Closing Ratio</span>
                                            ...
                                            <div class="dyk-stat-subtext">
                                                <span>Success <strong class="jumlahSuccess"></strong> from <strong class="total_donasinya"></strong></span>
                                            </div>
                                        </div>                                      
                                    </div>                                      
                                </div><!-- end col-->                                                       
                                                ...
                                                <div class="col-6 align-self-center">
                                                    <div class="table-responsive">
                                                        <table class="table border-dashed mb-0">
                                                            ...
                                                            <tbody>
                                                            <tr>
                                                                <th class="border-top-0 text-dark" scope="row" style="padding: 5px;"><i class="text-success font-24 mr-2 align-middle" data-lucide="smartphone"></i>Mobile</th>
                                                                <td class="border-top-0 text-right"><span id="jumlah_mobile">...</span></td>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-dark" scope="row" style="padding: 5px;"><i class="text-primary font-24 mr-2 align-middle" data-lucide="monitor"></i>Desktop</th>
                                ...
                                <div class="card-body">  
                                    ...
                                    <div id="by_date_box2" class="btn-group ml-1" style="position: absolute;margin-top: -30px;right: 0;margin-right: 40px;">
                                            ...
                                            <button id="by_download_button" type="button" class="btn btn-sm btn-outline-primary waves-light waves-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                                <i data-lucide="download"></i><i class="ml-1" data-lucide="chevron-down"></i> Download
                                            </button>
                                            <?php 
                                                if(isset($_GET['id'])){
                                                    $idnya = $_GET['id'];
        ...
        jQuery(document).ready(function($){
                    ...
                    const row = `
                        <tr>
                            <th class="border-top-0 text-dark" scope="row" style="padding: 0;border-top: 1px dashed #eaf0f7 !important;">
                                <i class="font-24 mr-2 align-middle" data-lucide="circle" style="color:${color};"></i>
            ...
            $(document.body).on("change",".campaign_select",function(){
                var c_id = (this.value);
                if(c_id=='show_all'){
                    var url = "<?php echo admin_url('admin.php?page=donasiyuk_data_analytics');?>";
                }else{
                    var url = "<?php echo admin_url('admin.php?page=donasiyuk_data_analytics&id=');?>"+c_id;
                }
