<?php
	...
	if (strpos(strtolower($donation->title), 'wakaf') !== false ) { 
		// echo 'WAKAF';
	}else{
		wp_redirect( get_site_url() );
		exit;
	...
	$qr_link = get_site_url().'/sertifikat/'.$invoice_id;
    ...
    $date_donation = $datenya->format('d').'&nbsp;'.$m.'&nbsp;'.$datenya->format('Y');
...
<html>
	<head>
	    ...
	    <title><?php if($donation->nominal<1000000){echo'Bukti Setor';}else{echo'Sertifikat';}?> Wakaf / <?php echo $nama; ?> / <?php echo $donation->invoice_id; ?></title>
		...
		<div class="book">
		    <div class="page">
			    ...
			    <div class="subpage" style="text-align: center;">
			        ...
			        <img style="width: 100%;border-radius: 4px;" src="https://res.cloudinary.com/dnxwdyrjq/image/upload/v1741651095/bg_certificate_hd_dwf5zq.jpg" />

				    <div style="position: absolute; width: 207mm;margin-top:-163mm">
			        	<?php if($donation->nominal<1000000){?>
			        	<p style="text-align: center;font-weight: bold;color:#00A59E;width: 500px;margin: 0 auto;background: #fff;margin-top: -28mm;font-size: 38px;padding: 10px 10px;">BUKTI SETOR WAKAF</p>
				        <?php } ?>
			        	<p style="text-align: center;font-weight: bold;color:#2C2E35;font-size:24px;<?php if($donation->nominal<1000000){ echo 'margin-top:50px;';}else{echo'margin-top:11px;';}?>"> Wakaf Uang</p>
				        <p style="text-align: center;font-weight: bold;color:#2C2E35;font-size:24px;margin-top:58px"><?php echo $show_currency2.$nominal_donasi?></p>
				        <table style="width: 122mm;margin-top: 20mm;margin-left: 42mm;font-size: 14px;color:#2C2E35;line-height:6mm;">
				        	<tr><td style="width: 18mm;">Nama</td><td style="width: 3mm;">:</td><td style="border-bottom: 2px solid #000;"><b><?php echo $nama; ?></b></td></tr>
				        	<tr><td style="width: 18mm;">Whatsapp</td><td style="width: 3mm;">:</td><td style="border-bottom: 2px solid #000;"><b><?php echo $whatsapp; ?></b></td></tr>
				        	<tr><td style="width: 18mm;">Email</td><td style="width: 3mm;">:</td><td style="border-bottom: 2px solid #000;"><b><?php echo $email; ?></b></td></tr>
				        	<tr><td style="width: 18mm;">Alamat</td><td style="width: 3mm;">:</td><td style="border-bottom: 2px solid #000;"><b><?php echo $alamat; ?></b></td></tr>
				        </table>
				        <p style="text-align: left;margin-top:15mm;margin-left: 85mm;font-size: 13px;font-weight: normal;">Jakarta, <?php echo $date_donation; ?></p>

				    </div>


				    <div class="col-left" style="margin-left:153mm;width: 180px;margin-top:-192px;text-align:right;">
			        	<a href="<?php echo $qr_link; ?>" target="_blank"><div class="container" id="qrcode-container-html"></div></a>
			        	<div class="col-left" style="padding: 0px 10px 5px 0px;font-size: 12px;color: #49a29c;margin-top: 5px;margin-right: -10px;">Please scan to validate</div>
			            <div><b style="background: white;color:#49a29c"><?php echo $donation->invoice_id; ?></b></div>
			        </div>
