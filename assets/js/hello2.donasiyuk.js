...
jQuery(document).ready(function($) {
	...
	$(".load_campaign").bind("click", function(){
	    ...
	    jQuery.post(donasiyukObjName.varSiteUrl + "/wp-admin/admin-ajax.php", data, function(response) {
	...
	$(".donasiyuk_search input").click(function (e) {
	...
	$(document).on("keypress",".input-search",function(e){
		if (e.which == 13) {
			var s = $(this).val();
		    var linkRedirect = donasiyukObjName.varSiteUrl+'/search_campaign/s?s='+s;
	...
	var check_s = $(".donasiyuk_search").attr('data-action');
	if (check_s=='run_search_donasiyuk') {
		var $head = $("head");
